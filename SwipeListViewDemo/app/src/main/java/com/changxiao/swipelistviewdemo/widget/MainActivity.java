package com.changxiao.swipelistviewdemo.widget;

import java.util.ArrayList;
import java.util.List;

import com.changxiao.swipelistviewdemo.R;
...
public class MainActivity extends Activity {
	...
	private int ids[]={R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher,R.mipmap.ic_launcher,
