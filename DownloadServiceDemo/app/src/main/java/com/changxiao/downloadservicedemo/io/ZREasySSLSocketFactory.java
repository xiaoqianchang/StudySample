 ...
 * @since 1.2.3
 */
public class ZREasySSLSocketFactory implements SocketFactory, LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
            ...
            context.init(null, new TrustManager[] { new ZREasyX509TrustManager(
                    null) }, null);
            return context;
        } catch (Exception e) {
    ...
    public boolean equals(Object obj) {
        return ((obj != null) && obj.getClass().equals(
                ZREasySSLSocketFactory.class));
    }

    @Override
    public int hashCode() {
        return ZREasySSLSocketFactory.class.hashCode();
    }
